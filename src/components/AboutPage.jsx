        ...
        <div className="h-screen w-screen bg-rose-300 pl-10  grid ">
            ...
            <div className="h-4/5 w-full mt-10  bg-rose-200 flex justify-between ">
                ...
                <div className="bg-rose-100 lack h-96 rounded-lg ml-12 mt-8 w-full">
                    ...
                    <p className="p-8 text-lg " >BookTheBook: A platform to search for books worldwide, find them, read them, and mediate on the book. If monks want to own an amazing copy of what you've read, just Book the Book</p>
